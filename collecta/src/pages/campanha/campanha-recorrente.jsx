                    ...
                    <div className="container-campanha">
                        <div className="w-770 d-flex fd-column">
                            <div className="titulo text-align-center d-flex fd-column">
                                <span className="head-medium">Crie sua divulgação</span>
                            </div>
                            <div className="mmb-32">
                                <div className="head-xsmall mmb-8">Qual o nome do seu projeto ?</div>
                                <input
                                    type="text"
                            ...
                            <div className="mmb-32">
                                <div className="head-xsmall mmb-8">Qual a categoria do seu projeto ?</div>
                            ...
                            <div className="mmb-32">
                                <div className="head-xsmall mmb-8">Informe qual será a utilização do dinheiro arrecadado:</div>
                                <textarea
                                    name=""
                                    id=""
                                    cols="30"
                            ...
                            <div className="mmb-32">
                                <div className="head-xsmall mmb-8">Qual sua meta de arrecadação ?</div>
                                <input
                                    type="text"
                                    className="w-100 br-10 h-65 border-outline p-16"
                                />
