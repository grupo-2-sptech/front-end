    ...
    <>
      ...
      <div className="background">
        <div className="container">
          <span className="head-large d-flex fd-column text-align-center">
            ...
            <div>
              <button className="btn-criar-campanha border-none bg-chambray color-white br-5 body-large">CRIAR CAMPANHA</button>
            </div>
          </span>
        </div>
      </div>
      ...
      <section className="text-align-center">
        ...
        <section className="sect-icone-sobre">
          ...
          <span className="body-xlarge texto-icone">Vivenciamos de perto a mudança ativa na sociedade, fauna e flora</span>
          </section>
        </section>
