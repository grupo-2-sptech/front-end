      ...
      <section className="p-16">
        <section className="card-texto d-flex fd-column">
          ...
          <span className="body-small mb-32">
            ...
            officiis voluptatibus ur soluta recusandae veniam! Ex voluptatibus
            doloribus nobis aspernatur accusamus, eaque debitis! Nulla eaque
            asperiores, eveniet omnis{" "}
          </span>
        </section>
        <progress
